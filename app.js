...
app.get("/" , (req, res)=>{
  ...
  Blog.find({}, (err, docs) => {
    if(!err){
      res.render("home", {firstBlog : homeStartingContent, Posts: docs});
    }else{
      console.log(err);
    }
  });
...
app.get("/:topic", (req, res) => {
  ...
  Blog.findOne({name : route}, (err, doc) => {
    if(!err && doc !== null){
      res.render("post", {name : doc.name, body : doc.body })
    }
  });
